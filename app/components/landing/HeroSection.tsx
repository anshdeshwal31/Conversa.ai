...
export default function HeroSection() {
    ...
    return (
        <section className='px-1 pt-2 pb-12 md:px-2'>
            <div className='surface-frame max-w-[1320px] mx-auto min-h-[70vh] md:min-h-[78vh] overflow-hidden relative'>
                <AuroraBackground
                    className='w-full h-full min-h-[70vh] md:min-h-[78vh] p-5 sm:p-6 md:p-12 lg:p-16'
                    showRadialGradient
                >
                    {/* Legacy glow orbs kept for layered depth */}
